...
export function RecurrenceBadge({
  ...
  item: { recurrence?: RecurrenceSeries | null; series?: SeriesLink | null };
}) {
  ...
  return (
    <span
      ...
      title={
        series
          ? `Repeats: ${describeRule(series.rule, series.anchor)}`
          : `Generated by a repeating series (occurrence #${item.series!.index})`
      }
    >
      <Badge className="border-brand-bright/30 bg-brand/15 text-brand-ink">
        <IconRepeat size={11} />
